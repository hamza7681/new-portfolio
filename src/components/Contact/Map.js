...
const Map = () => {
  return (
    <>
      <div className="flex flex-col lg:flex-row w-auto mx-10 lg:mx-14 py-[120px]  gap-4">
        <div className="w-full lg:w-2/5 bg-transparent border-[2px] rounded-[7px]">
              ...
              >
                ...
                >
                  {React.createElement(item.icon, {
                    size: 40,
                    className:
                      "text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ... cursor-pointer",
                  })}
                </a>
                <p className="text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ... cursor-pointer">
                  {item.title}
                </p>
              </div>
            ))}
        ...
        <div className="w-full lg:w-3/5 bg-transparent border-[2px] rounded-[7px]">
